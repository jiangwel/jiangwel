...
function Variable(){
  ...
  onFocusChanged.stopPropagation();
  ...
  //@brief:Great group
  chrome.tabs.onActivated.stopPropagation();
  ...
  */
  ...
  function tabFlow(object){
    ...
    tab.then(function(value){
      ...
      console.log("当前标签的ID:",object.currentId);
