...
import{Variable,addWindowsIdIntoArray,variableReset,tabFlow,addIdToList,groupManagement,createNewGroup,foldGroup,getGroupID,getGroupInfo,selectIntoGroupTab,groupAbout,getTabInfo,isSuccessSearch,moveGroup,preventBublle,changeGroupColor,tabHighlight} from "./declear.js";
...
chrome.runtime.onInstalled.addListener(()=>{
  ...
  chrome.storage.sync.set({maxTabs:'5 (笔记本推荐设置)'},function(){});
...
export {groupColor,windowsIdArray,currentWindowsId,variable1,variable2,variable3,sourseTime,hour,minute,second,time};